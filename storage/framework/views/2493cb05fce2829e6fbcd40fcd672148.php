...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="kodebarang" id="kodebarang" value="<?php echo e($barang->kodebarang); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="namabarang" id="namabarang" value="<?php echo e($barang->namabarang); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="hargabarang" id="hargabarang" value="<?php echo e($barang->hargabarang); ?>"
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="deskripsibarang" id="deskripsibarang" value="<?php echo e($barang->deskripsibarang); ?>"
...
unset($__errorArgs, $__bag); ?>" name="satuan_id"
                                id="satuan_id">
                                <?php $__currentLoopData = $satuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $satuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($satuan->id); ?>"
                                        <?php echo e($barang->satuan_id == $satuan->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER\Downloads\praktikum pf\zainal\resources\views/barang/edit.blade.php ENDPATH**/ ?>